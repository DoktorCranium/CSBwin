...
//;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      ...
      && (pNewTimer->Function() <= TT_MAP_LAST))
  {
    ...
    {
      //There was an "int D7W;" here and it declared nothing: D7W is a macro
      //for the emulated 68000 register, (D7.W[loWord]) - see CSB.h - so the line
      //expanded to the functional cast "int (D7.W[loWord]);", a discarded
      //expression.  The block below does not use D7W at all.  Removed.
  ...
  else
  {
    ...
    {
      //"i32 D7W;" here declared nothing either - see the note above.
      TIMER_SEARCH timerSearch;
      //for (D7W=0, ptA2=gameTimers.Timers(); D7W<d.MaxTimer(); D7W++, ptA2++) xxTIMERxx Change to FindNextTimer
      while (timerSearch.FindNextTimer())
      {
